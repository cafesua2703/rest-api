...
/*######################################################################################################
 'Project Name		: AutoTest framework for Selenium Web Driver
 'Author		    : AutoTest
 'Version	    	: V 3.1.0
...
public class TestSpringMVC{
	...
	private static final Logger LOGGER = Logger.getLogger(TestSpringMVC.class.getName());
	...
	//@Test
	public void readUtilFile(ModelAndView model) {
		   LoadLog();
		...
		try {
			...
			}else if(sheet.getRow(1).getCell(1).getCellType()==CellType.STRING){
				testSuite = sheet.getRow(1).getCell(1).getStringCellValue();
			}else if(sheet.getRow(1).getCell(1).getCellType()==CellType.FORMULA){
				testSuite = sheet.getRow(1).getCell(1).getStringCellValue();
			}


			if(sheet.getRow(2).getCell(1).getCellType()==CellType.BLANK)	{
				testScript ="";
			}else if(sheet.getRow(2).getCell(1).getCellType()==CellType.NUMERIC){
			double	password1 = sheet.getRow(2).getCell(1).getNumericCellValue();
			testScript = String.valueOf(password1);
			}else if(sheet.getRow(2).getCell(1).getCellType()==CellType.STRING){
				testScript = sheet.getRow(2).getCell(1).getStringCellValue();
			}else if(sheet.getRow(2).getCell(1).getCellType()==CellType.FORMULA){
				testScript = sheet.getRow(2).getCell(1).getStringCellValue();
			}


			if(sheet.getRow(3).getCell(1).getCellType()==CellType.BLANK)	{
				objectRepository ="";
			}else if(sheet.getRow(3).getCell(1).getCellType()==CellType.NUMERIC){
			double	password1 = sheet.getRow(3).getCell(1).getNumericCellValue();
			objectRepository = String.valueOf(password1);
			}else if(sheet.getRow(3).getCell(1).getCellType()==CellType.STRING){
				objectRepository = sheet.getRow(3).getCell(1).getStringCellValue();
			}else if(sheet.getRow(3).getCell(1).getCellType()==CellType.FORMULA){
				objectRepository = sheet.getRow(3).getCell(1).getStringCellValue();
			}



			if(sheet.getRow(5).getCell(1).getCellType()==CellType.BLANK)	{
				reportsPath ="";
			}else if(sheet.getRow(5).getCell(1).getCellType()==CellType.NUMERIC){
			double	password1 = sheet.getRow(5).getCell(1).getNumericCellValue();
			reportsPath = String.valueOf(password1);
			}else if(sheet.getRow(5).getCell(1).getCellType()==CellType.STRING){
				reportsPath = sheet.getRow(5).getCell(1).getStringCellValue();
			}else if(sheet.getRow(5).getCell(1).getCellType()==CellType.FORMULA){
				reportsPath = sheet.getRow(5).getCell(1).getStringCellValue();
			}

			if(sheet.getRow(6).getCell(1).getCellType()==CellType.BLANK)	{
				screenReport ="";
			}else if(sheet.getRow(6).getCell(1).getCellType()==CellType.NUMERIC){
			double	password1 = sheet.getRow(6).getCell(1).getNumericCellValue();
			screenReport = String.valueOf(password1);
			}else if(sheet.getRow(6).getCell(1).getCellType()==CellType.STRING){
				screenReport = sheet.getRow(6).getCell(1).getStringCellValue();
			}else if(sheet.getRow(6).getCell(1).getCellType()==CellType.FORMULA){
				screenReport = sheet.getRow(6).getCell(1).getStringCellValue();
			}


			if(sheet.getRow(7).getCell(1).getCellType()==CellType.BLANK)	{
				browserName ="";
			}else if(sheet.getRow(7).getCell(1).getCellType()==CellType.NUMERIC){
			double	password1 = sheet.getRow(7).getCell(1).getNumericCellValue();
			browserName = String.valueOf(password1);
			}else if(sheet.getRow(7).getCell(1).getCellType()==CellType.STRING){
				browserName = sheet.getRow(7).getCell(1).getStringCellValue();



			}else if(sheet.getRow(7).getCell(1).getCellType()==CellType.FORMULA){
				browserName = sheet.getRow(7).getCell(1).getStringCellValue();
			}


			if(sheet.getRow(9).getCell(1).getCellType()==CellType.BLANK)	{
				tempTestReportPath ="";
			}else if(sheet.getRow(9).getCell(1).getCellType()==CellType.NUMERIC){
			double	password1 = sheet.getRow(9).getCell(1).getNumericCellValue();
			tempTestReportPath = String.valueOf(password1);
			}else if(sheet.getRow(9).getCell(1).getCellType()==CellType.STRING){
				tempTestReportPath = sheet.getRow(9).getCell(1).getStringCellValue();
			}else if(sheet.getRow(9).getCell(1).getCellType()==CellType.FORMULA){
				tempTestReportPath = sheet.getRow(9).getCell(1).getStringCellValue();
			}


			if(sheet.getRow(8).getCell(1).getCellType()==CellType.BLANK)	{
				DriverPath ="";
			}else if(sheet.getRow(8).getCell(1).getCellType()==CellType.NUMERIC){
			double	password1 = sheet.getRow(8).getCell(1).getNumericCellValue();
			DriverPath = String.valueOf(password1);
			}else if(sheet.getRow(8).getCell(1).getCellType()==CellType.STRING){
				DriverPath = sheet.getRow(8).getCell(1).getStringCellValue();
				if (!DriverPath.endsWith(signPath)) { // checks whether the path ends with \

					DriverPath = DriverPath + signPath;
                                 }

			}else if(sheet.getRow(8).getCell(1).getCellType()==CellType.FORMULA){
				DriverPath = sheet.getRow(8).getCell(1).getStringCellValue();
			}

			if(sheet.getRow(11).getCell(1).getCellType()==CellType.BLANK)	{
				database ="";
			}else if(sheet.getRow(11).getCell(1).getCellType()==CellType.NUMERIC){
			double	password1 = sheet.getRow(11).getCell(1).getNumericCellValue();
			database = String.valueOf(password1);
			}else if(sheet.getRow(11).getCell(1).getCellType()==CellType.STRING){
				database = sheet.getRow(11).getCell(1).getStringCellValue();
			}else if(sheet.getRow(11).getCell(1).getCellType()==CellType.FORMULA){
				database = sheet.getRow(11).getCell(1).getStringCellValue();
			}

			if(sheet.getRow(12).getCell(1).getCellType()==CellType.BLANK)	{
				host_name ="";
			}else if(sheet.getRow(12).getCell(1).getCellType()==CellType.NUMERIC){
			double	password1 = sheet.getRow(12).getCell(1).getNumericCellValue();
			host_name = String.valueOf(password1);
			}else if(sheet.getRow(12).getCell(1).getCellType()==CellType.STRING){
				host_name = sheet.getRow(12).getCell(1).getStringCellValue();
			}else if(sheet.getRow(12).getCell(1).getCellType()==CellType.FORMULA){
				host_name = sheet.getRow(12).getCell(1).getStringCellValue();
			}


			if(sheet.getRow(13).getCell(1).getCellType()==CellType.BLANK)	{
				portnumber ="";
			}else if(sheet.getRow(13).getCell(1).getCellType()==CellType.NUMERIC){
				int	password1 = (int) sheet.getRow(13).getCell(1).getNumericCellValue();
				portnumber = String.valueOf(password1);
			}else if(sheet.getRow(13).getCell(1).getCellType()==CellType.STRING){
				portnumber = sheet.getRow(13).getCell(1).getStringCellValue();
			}else if(sheet.getRow(13).getCell(1).getCellType()==CellType.FORMULA){
				portnumber = sheet.getRow(13).getCell(1).getStringCellValue();
			}

			if(sheet.getRow(14).getCell(1).getCellType()==CellType.BLANK)	{
				schemaname ="";
			}else if(sheet.getRow(14).getCell(1).getCellType()==CellType.NUMERIC){
			double	password1 = sheet.getRow(14).getCell(1).getNumericCellValue();
			schemaname = String.valueOf(password1);
			}else if(sheet.getRow(14).getCell(1).getCellType()==CellType.STRING){
				schemaname = sheet.getRow(14).getCell(1).getStringCellValue();
			}else if(sheet.getRow(14).getCell(1).getCellType()==CellType.FORMULA){
				schemaname = sheet.getRow(14).getCell(1).getStringCellValue();
			}


			if(sheet.getRow(15).getCell(1).getCellType()==CellType.BLANK)	{
				username ="";
			}else if(sheet.getRow(15).getCell(1).getCellType()==CellType.NUMERIC){
			double	password1 = sheet.getRow(15).getCell(1).getNumericCellValue();
			username = String.valueOf(password1);
			}else if(sheet.getRow(15).getCell(1).getCellType()==CellType.STRING){
				username = sheet.getRow(15).getCell(1).getStringCellValue();
			}else if(sheet.getRow(15).getCell(1).getCellType()==CellType.FORMULA){
				username = sheet.getRow(15).getCell(1).getStringCellValue();
			}


		if(sheet.getRow(16).getCell(1).getCellType()==CellType.BLANK)	{
			password ="";
		}else if(sheet.getRow(16).getCell(1).getCellType()==CellType.NUMERIC){
		double	password1 = sheet.getRow(16).getCell(1).getNumericCellValue();
		password = String.valueOf(password1);
		}else if(sheet.getRow(16).getCell(1).getCellType()==CellType.STRING){
			password = sheet.getRow(16).getCell(1).getStringCellValue();
		}else if(sheet.getRow(16).getCell(1).getCellType()==CellType.FORMULA){
			password = sheet.getRow(16).getCell(1).getStringCellValue();
		}
		...
		try {
			...
			for(int i=0;i<browserlist.length;i++){
				...
				model.addObject("bw", bw);
				model.addObject("bw1", bw1);
				//screenReport
				Gson gson = new Gson();
				File[] images = Util.getAllFilesInPath(screenReport);
				model.addObject("listReport", Util.getFilesInPath(screenReport));
				model.addObject("listImage", Util.getFilesInPath(ScreenshotPath));
				model.addObject("listImage2", gson.toJson(Util.getFilesInPath(ScreenshotPath)));
				model.addObject("objImage", gson.toJson(Util.getAllFilesInPath(images)));
				close();
			}
	...
	private  String createConnection(String database, String schemaName, String username,
		...
		if(database.equalsIgnoreCase("mysql")){
			...
			String hostadd=  host_name.trim();
				...
				String url = "jdbc:mysql://"+host_name+":"+portnumber+"/"+schemaName+"?autoReconnect=true&useSSL=false";
	...
	public void findExecTestscript(String TestSuite, String TestScript,
			String ObjectRepository, ModelAndView model) throws Exception {
		try{
			...
			String htmlname = "Log" + "Test_Suite_" +  strTimeStamp+"_"+ browser
					+ ".html";
			String htmlname1 = rp + htmlname;
			//Thuy add
			model.addObject("htmlname", htmlname);
			File f = new File(strResultPath);
			model.addObject("absolutePath", fileReport.getAbsolutePath().toString());
...

	{
		...
		if (!reportsPath.endsWith(signPath))

		{

			reportsPath = reportsPath + signPath;
		}
		TCNm = scriptName.split(signPath+".");
		strResultPath = reportsPath + "Log" + signPath + TCNm[0] + signPath;
		String htmlname = reportsPath + "Log" + signPath + TCNm[0] + signPath
				+ strTimeStamp + ".html";
		...
		// 2016-03-28 A pass of a reference previous HTML was corrected in a relative path.
		DetailReport = "." + signPath + "Log" + signPath + TCNm[0] + signPath
				+ strTimeStamp + ".html";
		...
		try{
			Action =TScsheet.getRow(j).getCell(1).getStringCellValue();
				 ...
				 if(TScsheet.getRow(j).getCell(2).getCellType()== CellType.STRING)   {
					 cCellData = TScsheet.getRow(j).getCell(2).getStringCellValue();
				 }
				 else     if(TScsheet.getRow(j).getCell(2).getCellType()== CellType.NUMERIC)  {
				 ...
				 else     if(TScsheet.getRow(j).getCell(2).getCellType()== CellType.FORMULA)  {

					 evaluator.evaluateFormulaCell(TScsheet.getRow(j).getCell(2));
					 cCellData=TScsheet.getRow(j).getCell(2).getStringCellValue();
					  }
				 else     if(TScsheet.getRow(j).getCell(2).getCellType()== CellType.BLANK)  {
					 cCellDatanum = (int) TScsheet.getRow(j).getCell(2).getNumericCellValue();
					 cCellData="";
					  }

				 //ThuyHN add cell3
				 if (TScsheet.getRow(j).getCell(3) == null) {
					 dCellData="";
				 } else {
					 if( TScsheet.getRow(j).getCell(3).getCellType()==CellType.STRING){
						 dCellData =TScsheet.getRow(j).getCell(3).getStringCellValue();
					 }else if(TScsheet.getRow(j).getCell(3).getCellType() == CellType.BLANK){
						 dCellData="";
					 }

					 else 	 if(TScsheet.getRow(j).getCell(3).getCellType()==CellType.FORMULA){
					 ...
					 if(update.equalsIgnoreCase("yes")){
					  ...
					  else if(TScsheet.getRow(j).getCell(3).getCellType()==CellType.STRING){
						 dCellData = TScsheet.getRow(j).getCell(3).getStringCellValue();
					 }
					  if(TScsheet.getRow(j).getCell(3).getCellType()==CellType.NUMERIC){
							 double  dCellData1 = TScsheet.getRow(j).getCell(3).getNumericCellValue();
						  	  dCellData =String.valueOf(dCellData1);
						 }
				 }

				if(TScsheet.getRow(j).getCell(5) == null) {
					comments ="";
				}
				else {
					if(TScsheet.getRow(j).getCell(5).getCellType() == CellType.BLANK){
						sComments ="";
						comments =sComments;
					}else if(TScsheet.getRow(j).getCell(5).getCellType() == CellType.NUMERIC){
						nComments = TScsheet.getRow(j).getCell(5).getNumericCellValue();
						comments = Double.toString(nComments);
					}else if(TScsheet.getRow(j).getCell(5).getCellType()==CellType.STRING){
		...
		try {
			if (devFlag == 0) {
				...
				if (loopflag == 0) {
					...
					filenamer = screenReport + Sname + signPath + Sname + "_"+browser+"_"
		...
		try {
			...
			if (Res_type.startsWith("executed")) {
				...
				bw.write("<TR COLS=6><th colspan= 6 BGCOLOR=#EEEEEE WIDTH=5%><FONT FACE='WINGDINGS 2' SIZE=3 COLOR=RED><div align=left>X </FONT><FONT FACE=VERDANA SIZE=2 COLOR = RED>Error Occurred in  test step number. "
						+ (j + 1)
						+ ". "
						+ "Property not supported by AutoTest</div></th></FONT></TR>");
	...
	public static void update_Report(String Res_type, Exception e)
		...
		try {
			...
			if (Res_type.startsWith("failed")) {
				...
				bw.write("<TR COLS=6><th colspan= 6 BGCOLOR=#EEEEEE WIDTH=5%><FONT FACE='WINGDINGS 2' SIZE=3 COLOR=RED><div align=left>X </FONT><FONT FACE=VERDANA SIZE=2 COLOR = RED>Error Occurred in  test step number "
						+ (j + 1)
						+ ". Description: Keyword not supported by AutoTest</div></th></FONT></TR>");
													...
													// the report
	{
		try {
			...
			if (Res_type.startsWith("executed")
				...
				bw.write("<TR COLS=6><th colspan= 6 BGCOLOR=#EEEEEE WIDTH=5%><FONT FACE='WINGDINGS 2' SIZE=3 COLOR=RED><div align=left>X </FONT><FONT FACE=VERDANA SIZE=2 COLOR = RED>Error Occurred in test step number "
						+ (j + 1)
						+ ". This property is not supported by AutoTest</div></th></FONT></TR>");
			}
...
//						}
			...
			case "perform":
				...
				if (!(cCellObjType.equalsIgnoreCase("page")
						...
						|| cCellObjType.equalsIgnoreCase("uploadDialog"))
						&& !cCellData.isEmpty()) // //Updated on
																// 16.12.2013
																// for
																// supporting
																// page and
			...
			try {
				...
				switch (ObjectSet.toLowerCase()) {
					...
					case "sikuli-shifttab":
						...
						screen6.type(Key.SHIFT+Key.TAB);
						Thread.sleep(500);
						update_Report("sikuli");
						if (captureperform == true) {
							screenShot(loopnum, TScrowcount, TScname);
...
//						r.keyRelease(KeyEvent.VK_DOWN);
	...
	public static void func_InvokeFunction(String functionName,
		...
		try {
			TestSpringMVC s1 = new TestSpringMVC();
			Method[] declaredMethods = TestSpringMVC.class.getDeclaredMethods();
